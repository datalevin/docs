...
# Chapter 31: Episodic and Semantic Memory

Building on the cognitive analogies from Chapter 29, this chapter dives into the practical implementation of **Episodic** and **Semantic** memory systems in Datalevin. We will look at the schema patterns and query strategies that make these systems efficient at scale.

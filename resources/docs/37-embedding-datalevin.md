...
# Chapter 37: Embedding Datalevin in Applications

Datalevin's primary deployment mode is **Embedded** (Chapter 27). This means the database is not a remote service you "talk to," but a library that your application "becomes."

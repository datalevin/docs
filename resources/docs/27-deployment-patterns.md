...
# Chapter 27: Deployment Patterns: Embedded, Server, Replicas, HA, MCP, and Pods
...
Server mode (detailed in **Chapter 25**) is used when you need multiple services to share a single Datalevin instance, centralized RBAC, or remote access over `dtlv://` URIs.
